    ...
    <>
            ...
            <Container>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="me-auto NavLink-all">
                  ...
                  <Link to="/products" className='NavLink'>Products On Sale</Link>
      ...
      >
        <Offcanvas.Header closeButton>
          <Offcanvas.Title className="mobile_version_offcanvas_nav-title">Comradesbiz</Offcanvas.Title>
        </Offcanvas.Header>
        <Offcanvas.Body>


          <div className='mobile_version_links'>
            <Link to="/" className='mobile_navlink' >Home</Link>
            <Link to="/products" className='mobile_navlink'>Product On Sale</Link>
